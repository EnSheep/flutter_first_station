...
class ImageOptionPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const TextStyle labelStyle = TextStyle(fontSize: 16, fontWeight: FontWeight.bold,color: Colors.white);
...
class ImageOptionItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          Text(option.name, style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white)),
          Expanded(
            child: Padding(
